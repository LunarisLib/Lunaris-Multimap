...
namespace Lunaris {
    ...
    template<typename Store, typename... Keys>
    inline void multi_map<Store, Keys...>::erase(multi_map_iterator it)
    {
        objects.erase(it);
    }

    template<typename Store, typename... Keys>
    inline void multi_map<Store, Keys...>::erase(const_multi_map_iterator it)
    {
        objects.erase(it);
    }

    template<typename Store, typename... Keys>
    inline void multi_map<Store, Keys...>::erase(const_multi_map_iterator first, const_multi_map_iterator last)
    {
    ...
    template<typename MultiMap, typename Hint, typename ...Types>
    template<typename V, typename O, std::enable_if_t<(std::is_same_v<V, Hint> && (std::disjunction_v<std::is_same<O, Types>...>)), int>>
    inline MultiMap& __multi_map_work<MultiMap, Hint, Types...>::self()
    {
        return *this;
    }
    ...
    template<typename MultiMap, size_t siz, typename Hint, typename ...Types>
    template<typename V, typename O, std::enable_if_t<(std::is_same_v<V, Hint> && (std::disjunction_v<std::is_same<O, Types>...>)), int>>
    inline MultiMap& __fixed_multi_map_work<MultiMap, siz, Hint, Types...>::self()
    {
        return *this;
    }
